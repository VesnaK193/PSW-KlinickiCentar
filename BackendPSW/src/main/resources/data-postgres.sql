...
insert into termin(termin,radnikalendar_id) values ('2001-07-04T12:08:56.235-07:00',1);
...
insert into tippregleda (naziv, klinika_id, opis) values ('Osti Pregled', 1,'Opsti pregle pacijenata');
insert into tippregleda (naziv, klinika_id, opis) values ('Kardioloski Pregled', 1,'Kardioloski pregle pacijenata');

insert into sala (naziv, klinika_id, brojsale) values ('Glavna Sala', 1,'1');

insert into pregled (termin_id, sala_id, lekar_id, pacijent_id, tippregleda_id, cena, popust) values (1,1,1,1,1,1200.00, 10);